...
func (l *SysDictListLogic) SysDictList(in *tpmtclient.SysDictListReq) (*tpmtclient.SysDictListResp, error) {
	...
	var list []*tpmtclient.SysDictListData
	for _, item := range all {
		list = append(list, &tpmtclient.SysDictListData{
			Id:          item.Id,                         //字典类型ID
	...
	return &tpmtclient.SysDictListResp{
		Total: count,
		List:  list,
	}, nil
}
