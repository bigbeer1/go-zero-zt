...
func (l *SysDictTypeListLogic) SysDictTypeList(in *tpmtclient.SysDictTypeListReq) (*tpmtclient.SysDictTypeListResp, error) {
	...
	var list []*tpmtclient.SysDictTypeListData
	for _, item := range all {
		list = append(list, &tpmtclient.SysDictTypeListData{
			Id:          item.Id,                         //字典类型ID
	...
	return &tpmtclient.SysDictTypeListResp{
		Total: count,
		List:  list,
	}, nil
}
