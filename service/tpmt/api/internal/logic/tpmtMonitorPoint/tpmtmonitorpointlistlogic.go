...
func (l *TpmtMonitorPointListLogic) TpmtMonitorPointList(req *types.TpmtMonitorPointListRequest) (resp *types.Response, err error) {

	all, err := l.svcCtx.TpmtRpc.TpmtMonitorPointList(l.ctx, &tpmtclient.TpmtMonitorPointListReq{
	...
	var result TpmtMonitorPointListResp
...
type TpmtMonitorPointListResp struct {
	...
	List  []*TpmtMonitorPointDataList `json:"list"`
}

type TpmtMonitorPointDataList struct {
