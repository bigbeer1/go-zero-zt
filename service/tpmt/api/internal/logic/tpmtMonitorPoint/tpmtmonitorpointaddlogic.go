...
func (l *TpmtMonitorPointAddLogic) TpmtMonitorPointAdd(req *types.TpmtMonitorPointAddRequest) (resp *types.Response, err error) {
	// 用户登录信息
	tokenData := jwtx.ParseToken(l.ctx)

	_, err = l.svcCtx.TpmtRpc.TpmtMonitorPointAdd(l.ctx, &tpmtclient.TpmtMonitorPointAddReq{
