...
type ScheduledTasksFailureRecordLogFindListLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewScheduledTasksFailureRecordLogFindListLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ScheduledTasksFailureRecordLogFindListLogic {
	return &ScheduledTasksFailureRecordLogFindListLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
// 重试任务日志
func (l *ScheduledTasksFailureRecordLogFindListLogic) ScheduledTasksFailureRecordLogFindList(in *archiveclient.ScheduledTasksLogFindListReq) (*archiveclient.ScheduledTasksLogFindListResp, error) {
	...
	tdDb := &model.TdDb{
		DbName:    "scheduled_tasks_log.d2" + id,
		TableName: "",
	}
